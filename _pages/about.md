...
Check out my recent work, where we show how inference-time scaling and steering diffusion models can improve performance more than fine-tuning and even gradient-based guidance. Detailed blog post coming soon!
